...
if(ENVIRONMENT == 'development'){
    ...
    $dbconfigVars['database'] = 'jp';
}elseif (ENVIRONMENT == 'testing'){
    $dbconfigVars['hostname'] = 'localhost';
    $dbconfigVars['username'] = 'sample';
    $dbconfigVars['password'] = 'sample';
    $dbconfigVars['database'] = 'sample';
}elseif (ENVIRONMENT == 'production'){
    $dbconfigVars['hostname'] = '';
    $dbconfigVars['username'] = '';
    $dbconfigVars['password'] = '';
    $dbconfigVars['database'] = '';
}
$db['default'] = array(
	'dsn'	=> '',
