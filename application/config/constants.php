...
define( '__SITE_NAME__', 'JP');
if(ENVIRONMENT == 'development'){
    define('__BASE_URL__', 'http://localhost/jp');
}elseif (ENVIRONMENT == 'testing'){
    define('__BASE_URL__', 'https://www.abc.com');
}
...
define('__DBC_SCHEMATA_POSITIONS__', 'positions');
define('__DBC_SCHEMATA_COMPANIES__', 'companies');
define('__DBC_SCHEMATA_JOB_LISTING__', 'job_listing');
define('__DBC_SCHEMATA_SKILLS__', 'skills');
define('__DBC_SCHEMATA_EXPERIENCE__', 'experience');
define('__DBC_SCHEMATA_EDUCATION__', 'education');
define('__DBC_SCHEMATA_RESUME__', 'uploaded_resume');
define('__DBC_SCHEMATA_JOBS__', 'jobs');
