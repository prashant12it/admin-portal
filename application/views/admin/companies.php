    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-6" id="importFrm" style="display: none;">
                <form action="<?php echo __BASE_URL__ . '/import_companies'; ?>" method="post"
                      enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="shop_owner_email">Companies CSV:</label>
                        ...
                        <?php if (!empty($companyArr)) {
                            ...
                            foreach ($companyArr as $row) { ?>
                                <tr>
                                    ...
                                    <td><?php  echo (!empty($row['logo'])?'<img src="'.$row['logo'].'" width="50"/>':''); ?></td>
                                </tr>
                                <?php $i++;
                            }
                        } else { ?>
